...
function Carousel () {
  ...
  const carouselContent = [
    ...
    {label: "My Philosophy", description: " I am a strong believer that things get done better when we work as a team. As a result, in any job I always look forward to bringing my best and helping my team. After all, Rome wasn't built by one person."},
